...
parser.add_argument('--seed', default=1, type=int)                         #原来是100
...
parser.add_argument('--batch', default=5, type=int) #10
parser.add_argument('--optim', default='adam', help='sgd|adam')
parser.add_argument('--lr', default=1e-3, type=float)                               #原本-3
...
parser.add_argument('--label', default='all', help='nm|nm|all')
